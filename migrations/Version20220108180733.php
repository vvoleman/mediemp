 ...
 */
final class Version20220108180733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course_registration (id INT AUTO_INCREMENT NOT NULL, course_appointment_id INT NOT NULL, employee_id INT NOT NULL, absence SMALLINT DEFAULT NULL, test_done TINYINT(1) DEFAULT NULL, INDEX IDX_E362DF5A1A79D4CD (course_appointment_id), INDEX IDX_E362DF5A8C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
